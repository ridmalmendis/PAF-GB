...
public class CartRepository {
	...
	public List<Cart> getAllCartItemsBelongsToCustomer(int cusId){
		...
		*/
		String sql = "SELECT cart.cartId, cart.productId, products.image, products.productName, products.productPrice, cart.numOfItems, cart.totalPrice "
    ...
    public boolean updateCarts(Cart cart) {
        ...
        try {
            //System.out.println("1");
            connection = DBConnectionUtil.getDBconnection();
            String sql = "UPDATE cart SET numOfItems=? WHERE cartId=?";
